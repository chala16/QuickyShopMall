...
const Report = () => {
  ...
  return (
    <div>
      <Navbar />
      <div
        style={{ marginTop: "24px",marginRight:'40px', display: "flex", justifyContent: "flex-end" }}
      >
        <button
      ...
      <div className="relative text-gray-600 ">
          <input
            className="h-10 px-5 pr-16 text-sm bg-white border-2 border-gray-300 rounded-lg w-60 focus:outline-none"
            type="search"
            value={query}
